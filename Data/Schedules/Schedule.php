...
class Schedule extends Data implements IResponse
{
     ...
     * @param Optional|Collection|Lazy<int, ElementTypeData> $scheduled_types
     */
    public function __construct(
        ...
        #[OA\Property( title: 'Types using this schedule', type: 'array', items: new OA\Items(type: AttributeData::class))]
        #[AutoWhenLoadedLazy]
        /**
         * @var ElementTypeData[] $scheduled_types
         */
        public Collection|Optional|Lazy $scheduled_types,
