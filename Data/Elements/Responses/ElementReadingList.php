...
{
    /**
     * @param Collection<ElementReading> $data
     */
    public function __construct(

        #[OA\Property( title: 'Readings',description: "list of readings",type: 'array',items:  new OA\Items(type: ElementReading::class))]
    ...
    public  function findElementType(string $element_uuid, string $type_uuid) : ?ElementReading {
